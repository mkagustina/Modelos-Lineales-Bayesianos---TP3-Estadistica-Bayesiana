...
Podemos ver que el prior es bastante compatible con las observaciones. También notamos que los 3 puntos no están alineados. Esto puede deberse a que, si bien probamos que el logaritmo natural $T(t) - T_{\mathrm{amb}}$ es una función lineal de *t*, estamos suponiendo que la temperatura ambiente es fija cuando la última medición se realizó habiendo trasladado el cuerpo, por lo que sería raro que la temperatura ambiente realmente se mantenga.
...
rectas_posterior1 <-
  ...
  geom_vline(xintercept = lim_inf1, linetype = "dashed", color = "firebrick1") +
  geom_vline(xintercept = lim_sup1, linetype = "dashed", color = "firebrick1") +
    annotate("text", x = lim_inf1, y = 25, label = paste("x = 3.41"), color = "black", angle = 90, vjust = -0.5) +
  annotate("text", x = lim_sup1, y = 25, label = paste("x = 6.10"), color = "black", angle = 90, vjust = -0.5) +
  labs(x="Horario(hs)",y="T(t)", caption = "figura xxxxxxxxxx")+
  scale_x_continuous( breaks = seq(-3.75, 6.25, by = 2), labels = seq(3, 13, by = 2),expand = c(0, 0)) +
  theme_bw()
...
rectas_posterior2 <-
  ...
  geom_point(data=observaciones, aes(x=tiempo, y=exp(y)+22), size = 3) +
  geom_point(aes(x = t, y = temp), size = 4, color = "firebrick3") +
  geom_vline(xintercept = lim_inf2, linetype = "dashed", color = "firebrick1") +
  geom_vline(xintercept = lim_sup2, linetype = "dashed", color = "firebrick1") +
  annotate("text", x = lim_inf2, y = 25, label = paste("x = 4.06"), color = "black", angle = 90, vjust = -0.5) +
  annotate("text", x = lim_sup2, y = 25, label = paste("x = 6.12"), color = "black", angle = 90, vjust = -0.5) +
   labs(x="Horario(hs)",y="T(t)", caption = "figura xxxxxxxxxx")+
 scale_x_continuous( breaks = seq(-3.75, 6.25, by = 2), labels = seq(3, 13, by = 2),expand = c(0, 0)) +
  theme_bw()
...
rectas_posterior3 <-
  ...
  geom_hline(yintercept = 36.5, linetype = "dashed")  +
  geom_point(aes(x = t, y = temp), size = 4, color = "firebrick3") +
  geom_vline(xintercept = lim_inf3, linetype = "dashed", color = "firebrick1") +
  geom_vline(xintercept = lim_sup3, linetype = "dashed", color = "firebrick1") +
  annotate("text", x = lim_inf3, y = 25, label = paste("x = 3.43"), color = "black", angle = 90, vjust = -0.5) +
  annotate("text", x = lim_sup3, y = 25, label = paste("x = 6.07"), color = "black", angle = 90, vjust = -0.5) +
  labs(x="Horario(hs)",y="T(t)", caption = "figura xxxxxxxxxx")+
 scale_x_continuous( breaks = seq(-3.75, 6.25, by = 2), labels = seq(3, 13, by = 2),expand = c(0, 0)) +
  theme_bw()
