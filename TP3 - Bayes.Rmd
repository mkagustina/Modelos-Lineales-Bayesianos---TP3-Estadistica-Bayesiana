...
En ese tiempo, de esperar que la temperatura de su cuerpo haya descendido entre 2 y 4 grados, como mucho. Si consideramos la temperatura normal del cuerpo humano en 36.5ºC, entonces el $\ln(T(t) - T_{\mathrm{amb}})$ máximo es $\ln((36.5-2) - 22) = 2.526$ y el mínimo es $\ln((36.5-4) - 22) = 2.351$
Entonces podemos decir que $\beta_0$ tiene a priori una distribución normal con media $\mu_{\beta_0} = \frac{2.526 + 2.351}{2}=2.439$ y desvío $\sigma_{\beta_0} = \frac{2.526-2.439}{3} = 0.029$
...
**CAMBIO:** sin embargo, como Sergio murió desangrado y la pérdida de sangre puede acelerar el descenso de la temperatura corporal, se permitirá que *-r* tome valores entre -3 y -1. Por eso se propone a priori una distribución normal de media $\mu_{\beta_1} = \frac{-0.3-0.1}{2} = -0.2$ y desvío $\sigma_{\beta_1} = \frac{-0.1+0.2}{3} = 0.017$.
...
# Prior de Beta0 original
# mu_b0 <- 2.705
# sigma_b0 <- 0.012

# Prior de Beta1 original
# mu_b1 <- -0.15
# sigma_b1 <- 0.017
