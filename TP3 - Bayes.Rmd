...
Si nuevamente se utiliza una distribución normal, se obtiene que $\beta_1 \sim \mathcal{N}(\mu_{\beta_1},\sigma_{\beta_1})$, con media  $\mu_{\beta_1} = \frac{-0.2-0.1}{2} = -0.15$ y desvío $\sigma_{\beta_1} = \frac{-0.1+0.15}{3} = 0.017$.
