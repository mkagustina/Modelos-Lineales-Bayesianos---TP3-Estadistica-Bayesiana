...
rectas_posterior1 <-
  ...
  geom_point(data=observaciones, aes(x=tiempo, y=y), size = 3) +
  geom_point(aes(x = t, y = temp), size = 4, color = "firebrick3") +
  geom_vline(xintercept = -2.863) +
  geom_vline(xintercept = -0.502) +
...
rectas_posterior3 <-
  ...
  geom_hline(yintercept = 36.5, linetype = "dashed")  +
  geom_point(aes(x = t, y = temp), size = 4, color = "firebrick3") +
  geom_vline(xintercept = -3.4149) +
  geom_vline(xintercept = -0.706) +
  labs(x="Tiempo en horas",y="T(t)", caption = "figura xxxxxxxxxx")+
  scale_x_continuous(expand = c(0,0)) +
  theme_bw()
