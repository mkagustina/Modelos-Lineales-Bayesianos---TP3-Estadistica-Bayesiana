...
$$ = -r . [-T_{amb}+T(t)] = $$
$$ = r.[T_{amb} - T(t)] $$
Se grafica a continuación la función $T(t)$ para distintos valores de la constante $r$.
...
Ahora bien, para mayor simplicidad a la hora de modelizar se decide trabajar con la diferencia entre la temperatura del cuerpo y la temperatura ambiente $T - T_{amb}$ y se define $T_{diff} = T_i - T_{amb}$; por lo que se obtiene finalmente que $T(t) - T_{amb} = T_{diff} . e ^ {-rt}$. 
