...
Se asignarán distribuciónes a priori para los parámetros desconocidos $\beta_0$, $\beta_1$ y $\sigma$. Si bien $\mu$ también es desconocido, no se le asigna un prior propio ya que su valor depende exclusivamente de $\beta_0$ y $\beta_1$, de forma que una vez asignados valores para estos dos parámetros, $\mu$ queda definido. 
...
Por lo tanto, el modelo con las distribuciones a priori propuestas es:
